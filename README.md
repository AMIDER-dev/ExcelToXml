[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17197745.svg)](https://doi.org/10.5281/zenodo.17197745)
...
### 実行
#### モード1
データテーブルを要素名定義テーブルとサンプルXMLに従ってXMLファイルへ変換する。-xオプションが指定された場合は各XMLファイルに対してXSD妥当性検証を行う。-xオプションは同じディレクトリにあってもパス（./~）で指定する。
```
